...
class App:
    ...
    def beidanci(self):
        ...
        def check_whether_recite(old_rd):
            ...
            #        return old_rd
            for i in range(10):
                if data[old_rd[i]][0] in records and records[data[old_rd[i]][0]] >= 1:
                    while data[old_rd[i]][0] in records and records[data[old_rd[i]][0]] >= 1:
        ...
        for m in range(10):
            ...
            meaning_list[m] = data[rd[m]][1][0:100]
        ...
        word_box.pack(side=LEFT, padx=40)

        meaning_box = Label(newPage, text=meaning_text, width=100, justify=LEFT)
        ...
        def get_new_page():
            ...
            for m in range(10):
                ...
                meaning_list[m] = data[new_rd[m]][1][0:100]
            _var_text = '\n\n'.join(var_list)
            _meaning_text = '\n\n'.join(meaning_list)
    ...
    def review(self):
        ...
        meaning = '隐藏释义'
        meaningLabel = Label(reviewPage, text=meaning, font=('宋体', 17), justify=LEFT, width=101)
